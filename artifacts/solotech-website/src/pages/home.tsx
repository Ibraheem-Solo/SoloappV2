          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <h2 className="text-4xl md:text-5xl font-bold leading-tight" style={{ background: "linear-gradient(135deg, #ffffff 0%, #9CB633 50%, #592C72 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Built for Ambitious Brands</h2>
