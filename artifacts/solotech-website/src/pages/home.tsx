          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight">Built for Ambitious <span style={{ background: "linear-gradient(135deg, #9CB633 0%, #592C72 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", display: "inline-block" }}>Brands</span></h2>
