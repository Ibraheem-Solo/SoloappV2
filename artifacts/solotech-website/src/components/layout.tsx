        ...
        <div className="container mx-auto px-6 md:px-12 flex items-center">
          ...
          <div className="flex-1 flex items-center">
            <Link href="/" className="flex items-center gap-3 z-50">
              <img src={`${import.meta.env.BASE_URL}alif-logo-full.png`} alt="Alif" className="h-14 w-auto" />
            </Link>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="col-span-1 md:col-span-2">
              <img src={`${import.meta.env.BASE_URL}alif-logo-full.png`} alt="Alif" className="h-14 w-auto mb-6" />
